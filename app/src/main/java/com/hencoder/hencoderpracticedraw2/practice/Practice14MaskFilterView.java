...
public class Practice14MaskFilterView extends View {
    ...
    MaskFilter maskFilter2 = new BlurMaskFilter(20, BlurMaskFilter.Blur.INNER);
    MaskFilter maskFilter3 = new BlurMaskFilter(20, BlurMaskFilter.Blur.OUTER);
    MaskFilter maskFilter4 = new BlurMaskFilter(20, BlurMaskFilter.Blur.SOLID);
    @Override
