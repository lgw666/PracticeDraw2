...
public class Practice05ComposeShaderView extends View {
...

    {
        ...
        Shader bs = new BitmapShader(b1, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
        Shader bs2 = new BitmapShader(b2, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
        Shader cs = new ComposeShader(bs, bs2, PorterDuff.Mode.DST_IN);
        paint.setShader(cs);
    }
